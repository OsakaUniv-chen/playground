...
Swapping the beamformer alone — same audio window, same head boxes, same VAD, same labeling path — is therefore **safe**: it does not change the 4-label targeting decision, and the NEW generator is also ~7-8× faster.
