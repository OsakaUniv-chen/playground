...
class BaseSpectra(HasPrivateTraits):
    ...
    window = Trait(
        'Rectangular',
        {'Rectangular': ones, 'Hanning': hanning, 'Hamming': hamming, 'Bartlett': bartlett, 'Blackman': blackman, 'Blackman-Harris': blackmanharris},
        desc='type of window for FFT',
    )

    #: Overlap factor for averaging: 'None'(default), '50%', '75%', '87.5%'.
    overlap = Trait('None', {'None': 1, '50%': 2, '66.1%': 2.95, '75%': 4, '87.5%': 8}, desc='overlap of FFT blocks')
