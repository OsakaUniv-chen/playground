...
| [`generator-compare/`](generator-compare/) | comparison harnesses — `utils.py` (shared helpers) + `acoular-vs-pytorch/` + `1bit-vs-pytorch/` + `acoular-vs-1bit/` (on an emulated Intel N100) |
