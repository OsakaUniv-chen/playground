...
Reports four things per t+1..t+pred_len:
  ...
  - position correlation (Pearson r between predicted and true peak
    ...
    seventh-run (sixth-run's lr=1e-3 + noise/ratio augmentation fix, applied
    to fifth-run's full 278-bag pool) closes that gap at scale.
...
REPORT_HEADER = """# seventh-run 结果报告
